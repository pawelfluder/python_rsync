"""
rsync_sync_v3.py - Synchronizacja plikow do QNAP przy uzyciu rsync (bezpieczny flow)
...
- kasowanie zrodla tylko na samym koncu i tylko po podwojnym potwierdzeniu
"""
